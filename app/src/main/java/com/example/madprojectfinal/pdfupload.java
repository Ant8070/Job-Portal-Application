...
// while pdf is uploading
            ...
            Toast.makeText(pdfupload.this, imageuri.toString(), Toast.LENGTH_SHORT).show();

// Here we are uploading the pdf in firebase storage with the name of current time
            final StorageReference filepath = storageReference.child(messagePushID + "." + "pdf");
            Toast.makeText(pdfupload.this, filepath.getName(), Toast.LENGTH_SHORT).show();
...
// dialog box will be dismissed
                        ...
                        dialog.dismiss();
                        Toast.makeText(pdfupload.this, "UploadedFailed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
